...
**Supervisor-Modus (svc):** Privilegierter Modus, der für die meisten Kernel-Funktionen verwendet wird. Dieser Modus wird beim Zurücksetzen des Systems
oder bei der Ausführung einer Supervisor Call (SVC) Instruktion betreten.
**Monitor-Modus (mon):** Ein sicherer Modus, der den Wechsel zwischen sicheren und nicht sicheren Zuständen ermöglicht und auch für die Bearbeitung von 
