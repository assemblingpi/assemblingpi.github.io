...
|---------|---------|-----------|-----|----------|---------|----------|
| Cond    | 001     | Opcode    | S   | Rn       | Rd      | Operand2 | `Datenverarbeitungsbefehle`
...
|---------|---------|---|---|---|---|---|---|---------|---------|--------|
| Cond    | 01      | I | P | U | B | W | L | Rn      | Rd      | Offset |   `Load/Store Byte/ Word`
...
|---------|---------|---------|---------|---------|---------|------|-------|
| Cond    | 0001    | 0010    | 1111    | 1111    | 1111    | 0001 | Rn    | `Branch Exchange`
